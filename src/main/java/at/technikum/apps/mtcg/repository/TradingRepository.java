...
public class TradingRepository
{
    ...
    public Optional<String> getTradeOwner(String tradingDealId) throws SQLException
    {
        Connection con = MTCGDatabase.getConnection();
    ...
    public Optional<Float> getMindmg(String tradingDealId) throws SQLException
    {
        Connection con = MTCGDatabase.getConnection();
    ...
    public Optional<String> getCardIdFromTrade(String tradeid) throws SQLException
    {
        Connection con = MTCGDatabase.getConnection();
